...
A Java library for working with Table Schema. Snapshots on [![](https://jitpack.io/v/frictionlessdata/tableschema-java.svg)](https://jitpack.io/#frictionlessdata/tableschema-java)
